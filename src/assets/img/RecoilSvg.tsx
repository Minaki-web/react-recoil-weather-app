const RecoilSvg = () => {
  return (
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 2546.8 901.7"
      xmlSpace="preserve"
    >
      <path
        className="st0"
        d="M97.3,393c6.7-1.4,13.6-2.4,20.5-3l0,0l0,0l53.6-5.1l-72.8-79.8c-21.9-24.1-34-55.3-34-87.9H4.4
	c0,47.6,17.7,93.3,49.8,128.5L97.3,393z"
      />
      <path
        className="st0"
        d="M285.3,509.9c-5.4,1-10.9,1.7-16.4,2.3l0,0l0,0l-58,5.5l72.6,79.6c21.9,24.1,34,55.3,34,87.9h60.3
	c0-47.6-17.7-93.2-49.8-128.5L285.3,509.9z"
      />
      <path
        className="st0"
        d="M385,333c-9.9-49.2-48.5-85-98.3-91.3l-9.2-1.2c-31.1-3.9-54.6-30.5-54.6-61.8v-32.1c27.6-11.5,47-38.7,47-70.4
	...
	l138.3-13c22.8-2.2,44.4-9.1,64.2-20.5C373.3,430.2,394.9,382.2,385,333z"
      ...
      <path
        className="st0"
        d="M1426.6,675H1224c-69.8,0-126.6-56.8-126.6-126.6V362.8c0-69.8,56.8-126.6,126.6-126.6h108.3
	...
	h206.1c21.7,0,39.4-17.7,39.4-39.4v-29.2c0-37.8-30.8-68.6-68.6-68.6H1224c-37.8,0-68.6,30.8-68.6,68.6V431.4z"
      />
      <rect x="2363.4" y="272.7" className="st0" width="58" height="395.2" />
      <path
        className="st0"
        d="M2171.5,675h-108.3c-69.8,0-126.6-56.8-126.6-126.6V362.8c0-69.8,56.8-126.6,126.6-126.6h108.3
	...
	c0,37.8,30.8,68.6,68.6,68.6h108.3c37.8,0,68.6-30.8,68.6-68.6V362.8c0-37.8-30.8-68.6-68.6-68.6H2063.2z"
      />
      <path className="st0" d="M1965.6,460.3" />
      <rect x="2488.9" y="146.9" className="st0" width="58" height="521.1" />
      <rect x="2363.4" y="148.8" className="st0" width="58" height="54.3" />
      <path
        className="st0"
        d="M1747.3,679.8H1639c-69.8,0-126.6-56.8-126.6-126.6V367.5c0-69.8,56.8-126.6,126.6-126.6h108.3
	...
	c0,37.8,30.8,68.6,68.6,68.6h108.3c37.8,0,68.6-30.8,68.6-68.6v-29h58v29C1873.9,623,1817.1,679.8,1747.3,679.8z"
      />
      <path className="st0" d="M1541.4,465.1" />
      <path
        className="st0"
        d="M1011.7,685.1h-58v-20c0-34.6-13.1-67.7-37-93.3l-0.8-0.8l-54.8-69.1l45.5-36l53.3,67.3
	c33.4,36.2,51.7,83.1,51.7,131.9V685.1z"
      />
      <path
        className="st0"
        d="M710.4,685.1l-58-0.2l1.1-369.4c0.1-42.4,35.1-76.8,78.1-76.8l0.3,0c28.7,0.3,56.5-0.2,83.5-0.6
